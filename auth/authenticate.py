...
Based on: https://github.com/jptsantossilva/Streamlit-AWS-Cognito, see RESOURCES-LICENSES for license information.
Description: This file contains the functions to authenticate a user using AWS Cognito User Pool. 
